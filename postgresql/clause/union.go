...
func (u *UnionClause[T]) UnionIntersect(query sqb.QueryStmt[T]) T {
	return u.UnionType("INTERSECT", query)
}

func (u *UnionClause[T]) UnionIntersectAll(query sqb.QueryStmt[T]) T {
	return u.UnionType("INTERSECT ALL", query)
}

func (u *UnionClause[T]) UnionExcept(query sqb.QueryStmt[T]) T {
	return u.UnionType("EXCEPT", query)
}

func (u *UnionClause[T]) UnionExceptAll(query sqb.QueryStmt[T]) T {
