...
func TestInsertStmt_ColumnsSeparatelyFromSetOfValues(t *testing.T) {
	...
	sqb.CheckSql(t, "INSERT INTO tb (c1, c2, c3) VALUES (:p1, :p2, :p3), (:p4, :p5, :p6), (:p7, :p8, :p9)", st.String())
	sqb.CheckParams(t, map[string]any{
		"p1": "v1",
		"p2": "v2",
		"p3": "v3",
...
func TestInsertStmt_ColumnsAndSetOfValuesAsSingleParameter(t *testing.T) {
	st := NewInsertStmt(nil).
		...
		Values([]any{
			...
			[]any{sqb.Map("c1", "v4", "c2", "v5", "c3", "v6")},
			[]any{sqb.Map("c1", "v7", "c2", nil, "c3", sql.NewExp("DEFAULT"))},
		},
		)

	sqb.CheckSql(t, "INSERT INTO tb (c1, c2, c3) VALUES (:p1, :p2, :p3), (:p4, :p5, :p6), (:p7, NULL, DEFAULT)", st.String())
	sqb.CheckParams(t, map[string]any{
		"p1": "v1",
		"p2": "v2",
		"p3": "v3",
...
func TestInsertStmt_OnConflictDoUpdateWithConstraintAndMultipleConditions(t *testing.T) {
	...
	sqb.CheckSql(t, "INSERT INTO tb DEFAULT VALUES ON CONFLICT (c1) WHERE c2 = :p1 AND c3 < :p2 ON CONSTRAINT const "+
		"DO UPDATE SET c3 = :p3 WHERE c5 > :p4 OR c6 < :p5", st.String())
